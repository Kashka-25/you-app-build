...
function onTypeChange(){var t=document.getElementById("newType").value;document.getElementById("msToggle").style.display=t==="habit"?"none":"block";}
...
async function unachieveItem(id){
  ...
  render();
  await saveItem(item);
  showToast("Moved back to active. XP reversed.");
  setSync("synced");
}
